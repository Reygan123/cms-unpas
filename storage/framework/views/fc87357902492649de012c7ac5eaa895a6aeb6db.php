...
<?php if($paginator->hasPages()): ?>
    <ul class="pagination justify-content-center">
        ...
        <?php if(!$paginator->onFirstPage()): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->url(1)); ?>">First</a>
            </li>
        <?php endif; ?>
        ...
        <?php if($paginator->currentPage() != $paginator->lastPage()): ?>
            <li class="page-item">
                <a class="page-link" href="<?php echo e($paginator->url($paginator->lastPage())); ?>">Last</a>
            </li>
        <?php endif; ?>
    </ul>
<?php endif; ?>
<?php /**PATH /var/www/cms.jatidiri.app/resources/views/vendor/pagination/custom.blade.php ENDPATH**/ ?>