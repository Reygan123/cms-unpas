                ...
                <div class="pbmit-sticky-col">
                    <div class="pbmit-ele-header-area">
                        <div class="pbmit-heading-subheading">
                            ...
                            <div class="row">
                                <?php if($program->dukungans->count() == 1): ?>
                                    <div class="col-12">
                                        <?php $__currentLoopData = $program->dukungans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dukungan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="image-container mt-4">
                                                <img src="<?php echo e(asset('storage/dukungans/' . $dukungan->image)); ?>"
                                                    class="img-fluid img-thumbnail image-rounded h-250" alt="Gambar">
                                                <div class="text-overlay">
                                                    <a class="button is-play pbmin-lightbox-video"
                                                        href="https://www.youtube.com/watch?v=<?php echo e($dukungan->id_yt); ?>">
                                            ...
                                            <div class="mt-2 mx-4"><?php echo e($identities[0]->name); ?> menurut <?php echo e($dukungan->jabatan); ?></div>
                                ...
                                <?php else: ?>
                                    <?php $__currentLoopData = $program->dukungans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dukungan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2 mx-4"><?php echo e($dukungan->jabatan); ?></div>
            ...
            <div class="col-md-12 col-lg-6 ">
                <div class="pbmit-servicebox-right">
                    <div data-bs-spy="scroll" class="scrollspy-example-2 card-bg-white p-5" tabindex="0">
                        <h4 class="mb-4"><?php echo e($program->title2); ?></h4>
                        <?php echo $program->description2; ?>
...
<?php /**PATH /var/www/cms.jatidiri.app/resources/views/front/program/narasi.blade.php ENDPATH**/ ?>