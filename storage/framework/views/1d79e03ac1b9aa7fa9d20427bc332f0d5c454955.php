            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.unggulan.update', $unggulan->id)); ?>" method="POST"
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group mb-4">
                                                <input type="checkbox" name="home" id="home" value="1"
                                                    <?php echo e(old('home', $unggulan->home) ? 'checked' : ''); ?>>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <select class="form-control" name="program_id">
                                                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option class="py-1" value="<?php echo e($program->id); ?>"
                                                            <?php if($unggulan->program_id == $program->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                    value="<?php echo e(old('title', $unggulan->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea id="editor1" name="description" rows="15"><?php echo e(old('description', $unggulan->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2 mt-4">
                                                <?php if($unggulan->image): ?>
                                                    <img src="<?php echo e(asset('storage/unggulans/' . $unggulan->image)); ?>"
                                                        alt="<?php echo e($unggulan->title); ?>" class="admin-edit-image">
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', ['title' => 'Features'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cms.jatidiri.app/resources/views/admin/unggulan/edit.blade.php ENDPATH**/ ?>