                ...
                <div class="pbmit-featured-container">
                  ...
                  <div class="pbmit-meta-cat-wrapper pbmit-meta-line">
                    <div class="pbmit-meta-category">
                      <a href="<?php echo e(route('post.post.index',['category'=>$a->category->slug])); ?>" rel="category tag"><?php echo e($a->category->name); ?></a>
                    </div>
                  </div>
                  ...
                  <div class="pbmit-meta-date-wrapper pbmit-meta-line">
                    <div class="pbmit-meta-date">
                      <span class="pbmit-post-date">
                        <i class="pbmit-base-icon-calendar-3"></i><?php echo e(date('d M Y', strtotime($a->pub_date))); ?>
...
</section><?php /**PATH /var/www/cms.jatidiri.app/resources/views/front/frontpage/blog.blade.php ENDPATH**/ ?>