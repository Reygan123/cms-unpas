      ...
      <form
        ...
        <div>
          ...
          <textarea
            ...
            rows="4"
            class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md focus:outline-none focus:ring focus:border-[#034833]"
            placeholder="Write the agenda description...">{{ old('description', $agenda->description) }}</textarea>
        </div>
        ...
        <div class="flex items-center gap-2">
          <input
            name="is_academic_calendar"
            id="is_academic_calendar"
            type="checkbox"
            value="1"
            {{ old('is_academic_calendar', $agenda->is_academic_calendar) ? 'checked' : '' }}
            class="w-4 h-4 border-2 border-gray-300 rounded focus:ring focus:border-[#034833]" />
          <label for="is_academic_calendar" class="text-sm font-medium text-gray-700">
            Tampilkan di Kalender Akademik
          </label>
        </div>
