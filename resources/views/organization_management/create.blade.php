<x-layout title="Add Management Member">
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <h2 class="text-xl font-bold mb-4">Add Management Member for {{ $studentOrganization->nama }}</h2>
            <form action="{{ route('student-organizations.organization-managements.store', $studentOrganization->id) }}" method="post" enctype="multipart/form-data" id="form-management">
            @csrf
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <select name="jabatan" id="jabatan" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-select border-gray-300 border-2 p-2 rounded-md">
                            ...
                            <option value="kepala_bidang" {{ old('jabatan') == 'kepala_bidang' ? 'selected' : '' }}>Kepala Bidang</option>
                        </select>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="nama_bidang" value="{{ old('nama_bidang') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="number" name="urutan" value="{{ old('urutan') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
