            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.tanggalpenting.update', $tanggalpenting->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="date"
                                                    value="{{ old('date',$tanggalpenting->date) }}">
                                                @error('date')
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                    value="{{ old('title',$tanggalpenting->title) }}">
                                                @error('title')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea id="editor1" name="description" rows="15">{{ old('description',$tanggalpenting->description) }}</textarea>
                                        @error('description')
                                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                <div class="px-4 py-2">
                                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
