            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.program.create.halaman-ketiga') }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        <div role="application" class="wizard clearfix" id="steps-uid-0">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input class="form-control" type="text" name="title4"
                                                            value="{{ old('title4') }}" placeholder="Title Section 4">
                                                        @error('title4')
                                                            <div
                                                    ...
                                                    <div class="form-group mb-4">
                                                        <label class="text-label" for="description4">Description Section
                                                            4</label>
                                                        <textarea id="editor1" name="description4">{{ old('description4') }}</textarea>
                                                        @error('description4')
                                                            <div
                                                                class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                                <div class="px-4 py-2">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mt-4">
                                                        <label class="text-gray-700" for="image4">Upload Image (Max Size:
                                                            750kb)</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <textarea id="editor3" name="time_table">{{ old('time_table') }}</textarea>
                                                        @error('time_table')
                                                            <div
                                                                class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                                <div class="px-4 py-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <textarea id="editor4" name="time_table2">{{ old('time_table2') }}</textarea>
                                                        @error('time_table2')
                                                            <div
                                                                class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                                <div class="px-4 py-2">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input class="form-control" type="text" name="cta"
                                                    value="{{ old('cta') }}" placeholder="Call to Action">
                                                @error('cta')
                                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                        <div class="px-4 py-2">
                                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input class="form-control" type="text" name="brosur"
                                                            value="{{ old('brosur') }}" placeholder="Link untuk brosur">
                                                        @error('brosur')
                                                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                                <div class="px-4 py-2">
                                                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
