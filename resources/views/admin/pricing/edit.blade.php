                            ...
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <select class="form-control" name="program_id">
                                                    @foreach ($programs as $program)
                                                        <option class="py-1" value="{{ $program->id }}"
                                                            @if ($pricing->program_id == $program->id) selected @endif>
                                                            {{ $program->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="number" class="form-control" name="diskon"
                                                    value="{{ old('diskon', $pricing->diskon) }}">
                                                @error('diskon')
                                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden">
                                                        <div class="px-4 py-2">
                                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea id="editor1" name="description" rows="15">{{ old('description', $pricing->description) }}</textarea>
                                        @error('description')
                                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                <div class="px-4 py-2">
                                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
