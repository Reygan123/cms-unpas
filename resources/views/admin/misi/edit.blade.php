        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.misi.update', $misi->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{ old('title', $misi->title) }}">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="subtitle" value="{{ old('subtitle', $misi->subtitle) }}">
                                    @error('subtitle')
                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                        <div class="px-4 py-2">
                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
                                ...
                                <div>
                                    <label class="text-gray-700" for="misi">Mission</label>
                                    <textarea id="editor" name="misi" rows="15">{{ old('misi', $misi->misi) }}</textarea>
                                    @error('misi')
                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                        <div class="px-4 py-2">
                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
