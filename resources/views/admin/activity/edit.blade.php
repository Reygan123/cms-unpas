@extends('layouts.app', ['title' => 'Edit Activity'])
                        ...
                        <form action="{{ route('admin.activity.update', $activity->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            @if ($activity->image)
                                                <div id="oldPreview">
                                                    <img src="{{ asset('storage/activitys/' . $activity->image) }}"
                                                        width="200" class="img-thumbnail">
                                                    <p class="mt-2">{{ $activity->image }}</p>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor1" name="description" rows="15">{{ old('description', $activity->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route('admin.activity.index') }}" class="btn btn-warning">
