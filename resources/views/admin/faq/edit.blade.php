                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4">
                        <div class="mt-4">
                            ...
                            <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                                name="title" value="{{ old('title', $faq->title) }}" placeholder="pertanyaan">
                            @error('title')
                        ...
                        <div class="mt-4">
                            ...
                            <select class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" name="category"
                                required>
                                <option value="">Select Category</option>
                                <option value="Layanan"
                                    {{ old('category', $faq->category) == 'Layanan' ? 'selected' : '' }}>Layanan</option>
                                <option value="Paket"
                                    {{ old('category', $faq->category) == 'Paket' ? 'selected' : '' }}>Paket</option>
                            </select>
                            @error('category')
                                <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                    <div class="px-4 py-2">
