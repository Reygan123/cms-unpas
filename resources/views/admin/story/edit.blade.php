                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group mb-4">
                                                ...
                                                <input class="form-control" type="text" name="year" value="{{ old('year',$story->year) }}" >
                                                @error('year')
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input class="form-control" type="text" name="title" value="{{ old('title',$story->title) }}" >
                                                @error('title')
                                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                        <div class="px-4 py-2">
                                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor1" class="form-control" name="description" rows="3">{{ old('description', $story->description) }}</textarea>
                                                @error('description')
                                                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                                        <div class="px-4 py-2">
                                                            <p class="text-gray-600 text-sm">{{ $message }}</p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-2 mt-4">
                                                @if ($story->image)
                                                    <img src="{{ asset('storage/stories/' . $story->image) }}"
                                                        alt="{{ $story->title }}" class="admin-edit-image">
                                                @else
