<x-layout title="Add Academic Document">
    ...
    <div class="p-3 md:p-5 flex items-center justify-center">
        <div class="w-full bg-white p-4 md:p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('academic-documents.store') }}" method="post" enctype="multipart/form-data" id="form-departement">
            @csrf
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <select name="kategori" id="kategori" onchange="toggleSubKategori()"
                                ...
                                <option value="buku_panduan" {{ old('kategori') == 'buku_panduan' ? 'selected' : '' }}>Buku Panduan</option>
                        ...
                        <div class="flex flex-col gap-1 mb-5" id="wrap-sub-kategori">
                            ...
                            <select name="sub_kategori" id="sub_kategori"
                                ...
                                <option value="skripsi_ta" {{ old('sub_kategori') == 'skripsi_ta' ? 'selected' : '' }}>Skripsi / Tugas Akhir</option>
                                <option value="kp_magang" {{ old('sub_kategori') == 'kp_magang' ? 'selected' : '' }}>KP / Magang</option>
                                <option value="mbkm" {{ old('sub_kategori') == 'mbkm' ? 'selected' : '' }}>MBKM</option>
                                <option value="perkuliahan_evaluasi" {{ old('sub_kategori') == 'perkuliahan_evaluasi' ? 'selected' : '' }}>Perkuliahan & Evaluasi</option>
                                <option value="kemajuan_studi" {{ old('sub_kategori') == 'kemajuan_studi' ? 'selected' : '' }}>Kemajuan Studi</option>
                                <option value="yudisium_kelulusan" {{ old('sub_kategori') == 'yudisium_kelulusan' ? 'selected' : '' }}>Yudisium & Kelulusan</option>
                            </select>
                            @error('sub_kategori')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="nomor_dokumen" id="nomor_dokumen" value="{{ old('nomor_dokumen') }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('nomor_dokumen')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <input type="text" name="tahun_akademik" id="tahun_akademik" value="{{ old('tahun_akademik') }}" placeholder="2025/2026"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                        ...
                        <div class="flex flex-col gap-1 mb-5">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="direvisi" {{ old('status') == 'direvisi' ? 'selected' : '' }}>Direvisi</option>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div>
                                <small class="text-red-500"><i>{{ $message }}</i></small>
                            </div>
                ...
                <div class="col-span-1">
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                            ...
                            <span id="file-name" class="text-gray-400 z-0 text-center px-2 break-all">Klik untuk pilih file PDF</span>
                        </div>
                        @error('file')
