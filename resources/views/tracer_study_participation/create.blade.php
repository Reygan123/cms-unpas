<x-layout title="Add Tracer Study Participation">
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('tracer-study-participations.store') }}" method="post" id="form-participation">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="angkatan" value="{{ old('angkatan') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="number" name="jumlah_target" value="{{ old('jumlah_target') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="number" name="jumlah_mengisi" value="{{ old('jumlah_mengisi') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
