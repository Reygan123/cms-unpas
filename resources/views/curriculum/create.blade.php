<x-layout title="Add Curriculum Period">
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('curriculum-periods.store', $departement->id) }}" method="post" enctype="multipart/form-data" id="form-curriculum">
            @csrf
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" name="tahun_kurikulum" value="{{ old('tahun_kurikulum') }}" placeholder="Contoh: 2024"
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="number" name="jumlah_semester" value="{{ old('jumlah_semester') }}" min="1" max="14"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="number" name="total_sks" value="{{ old('total_sks') }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('total_sks')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="program_kampus_berdampak" id="program_kampus_berdampak" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('program_kampus_berdampak') }}</textarea>
