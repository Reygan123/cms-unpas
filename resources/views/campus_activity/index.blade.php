<!-- index.blade.php -->
<x-layout title="Campus Activities">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('campus-activities.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
            ...
            <form action="{{ route('campus-activities.index') }}" method="GET" class="mb-4 flex items-center gap-2 mt-4">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a
                                        href="{{ route('campus-activities.edit', $activity->id) }}"
                                    ...
                                    <form action="{{ route('campus-activities.destroy', $activity->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
