<x-layout title="Alumni Networking Resources">
    <div class="p-5">
        <div class="flex items-center justify-between">
            <a href="{{ route('alumni-networking-resources.create') }}" class="py-2 px-3 bg-[#5676ff] rounded-full flex items-center hover:bg-gray-900 text-white gap-3 text-xs">
                ...
                <span>Add Networking Resource</span>
            </a>
            <form action="{{ route('alumni-networking-resources.index') }}" method="GET" class="mb-4 flex items-center gap-2 mt-4">
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        @foreach ($alumniNetworkingResources as $resource)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a
                                        href="{{ route('alumni-networking-resources.edit', $resource->id) }}"
                                    ...
                                    <form action="{{ route('alumni-networking-resources.destroy', $resource->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button
                                            type="button"
