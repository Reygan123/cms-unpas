<x-layout title="Add Student Organization">
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('student-organizations.store') }}" method="post" enctype="multipart/form-data" id="form-org">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                <div class="col-span-1 md:col-span-2 gap-5">
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="singkatan" value="{{ old('singkatan') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="deskripsi_singkat" id="deskripsi_singkat" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('deskripsi_singkat') }}</textarea>
                        @error('deskripsi_singkat')<div><small class="text-red-500"><i>{{ $message }}</i></small></div>@enderror
                    </div>
                    <div class="flex flex-col gap-1 mb-5">
                        <label for="visi">Visi</label>
                        <textarea name="visi" id="visi" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('visi') }}</textarea>
                        @error('visi')<div><small class="text-red-500"><i>{{ $message }}</i></small></div>@enderror
                    </div>
                    <div class="flex flex-col gap-1 mb-5">
                        <label for="misi">Misi</label>
                        <textarea name="misi" id="misi" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('misi') }}</textarea>
                        @error('misi')<div><small class="text-red-500"><i>{{ $message }}</i></small></div>@enderror
                    </div>
                    <div class="flex flex-col gap-1 mb-5">
                        <label for="tujuan">Tujuan</label>
                        <textarea name="tujuan" id="tujuan" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('tujuan') }}</textarea>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="nilai_organisasi" id="nilai_organisasi" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('nilai_organisasi') }}</textarea>
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="ruang_lingkup" id="ruang_lingkup" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('ruang_lingkup') }}</textarea>
                        @error('ruang_lingkup')<div><small class="text-red-500"><i>{{ $message }}</i></small></div>@enderror
                    </div>
                    <div class="flex flex-col gap-1 mb-5">
                        <label for="ketua">Ketua</label>
                        <input type="text" name="ketua" value="{{ old('ketua') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <input type="text" name="periode_kepengurusan" value="{{ old('periode_kepengurusan') }}" class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                    ...
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <textarea name="media_sosial" id="media_sosial" class="block w-full mt-1 text-sm border-gray-300 border-2 p-2 rounded-md">{{ old('media_sosial') }}</textarea>
                ...
                <div class="col-span-1 gap-5 flex flex-col">
                    <div class="flex flex-col gap-1 mb-5">
                        ...
                        <div class="relative w-full h-40 border-2 border-dashed rounded-md flex items-center justify-center bg-gray-50 overflow-hidden">
                            ...
                            <span id="upload-text" class="text-gray-400 z-0 text-center px-2">Klik untuk pilih logo</span>
                        </div>
