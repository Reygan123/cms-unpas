<x-layout title="Edit Tracer Study">
    <div class="p-5 flex items-center justify-center">
        <div class="w-full bg-white p-5 rounded-xl text-sm flex flex-col">
            <form action="{{ route('tracer-studies.update', [$departement->id, $tracerStudy->id]) }}" method="post" id="form-tracer-study">
            @csrf
            @method('PUT')
                ...
                <div class="col-span-1 md:col-span-2 gap-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" name="tahun" value="{{ old('tahun', $tracerStudy->tahun) }}"
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" name="label" value="{{ old('label', $tracerStudy->label) }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('label')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="number" step="0.01" name="nilai" value="{{ old('nilai', $tracerStudy->nilai) }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('nilai')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" name="satuan" value="{{ old('satuan', $tracerStudy->satuan) }}"
                                class="block w-full mt-1 text-sm focus:border-[#5676ff] focus:outline-none focus:shadow-outline-purple form-input border-gray-300 border-2 p-2 rounded-md" />
                            @error('satuan')
                                <div>
                                    <small class="text-red-500"><i>{{ $message }}</i></small>
