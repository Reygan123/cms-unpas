    ...
    <div class="container">
        <div class="row service_details ">
            <div class="col-md-4 pbmit-service-feature-image visi-image">
                <img src="{{ asset('storage/identities/' . $visis[0]->image) }}" alt="" class="img-fluid w-100 mt-5 ">
                <div class="pbmit-ihbox-style-15">
                    <div class="pbmit-ihbox-box"> 
                        <div class="pbmit-icon-wrap d-flex align-items-center">
                            <div class="pbmit-ihbox-icon">
                                <div class="pbmit-ihbox-icon-wrapper">
                                    <h3 class="text-center">{{strip_tags($visis[0]->title)}}</h3>
                                </div>
                            </div>
                        </div>
                        <h5 class="pbmit-element-title-endar">{{ strip_tags($visis[0]->visi) }}</h5>
                    </div>
                ...
                <div class="comment-respond">
                    <div class="pbmit-ihbox-style-16">
                        ...
                        <div class="pbmit-ihbox-contents">
                            <h2 class="pbmit-title">{{ $misis[0]->title }}</h2>
                        </div>
                    </div>
                    <div class="mt-5 list-endar">{!! $misis[0]->misi !!}</div>
                </div>
            </div>
        </div>
    </div>
