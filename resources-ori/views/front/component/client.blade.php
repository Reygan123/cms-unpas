<section class="section-lg">
    <div class="container">
        <div class="pbmit-heading-subheading text-center">
            ...
            <h2 class="pbmit-title">Pengguna {{ $program->name }}</h2>
        </div>
                        ...
                        <article class="pbmit-client-style-1">
                            <div class="pbmit-border-wrapper">
                                <div class="pbmit-client-wrapper ">
                                    <h4 class="pbmit-hide">{{ $porto->title }}</h4>
                                    <div class="image-container mt-4">
                                        <img src="{{ asset('storage/portofolios/' . $porto->logo) }}"
                                            class="img-fluid img-thumbnail image-rounded" alt="Gambar">
                                        @if ($porto->yt_id)
                                        <div class="text-overlay">
                                            <a class="button is-play pbmin-lightbox-video"
                                                href="https://www.youtube.com/watch?v={{ $porto->yt_id }}">
                    ...
                    <article class="pbmit-client-style-1">
                        <div class="pbmit-border-wrapper">
                            <div class="pbmit-client-wrapper">
                                <h4 class="pbmit-hide">{{ $porto->title }}</h4>
                                <div class="image-container mt-4">
                                    <img src="{{ asset('storage/portofolios/' . $porto->logo) }}" class="img-fluid img-thumbnail image-rounded" alt="Gambar">
                                    @if($porto->yt_id)
                                    <div class="text-overlay">
                                        <a class="button is-play pbmin-lightbox-video" href="https://www.youtube.com/watch?v={{ $porto->yt_id }}">
                                            <div class="button-outer-circle has-scale-animation"></div>
