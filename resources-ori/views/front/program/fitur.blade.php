<section class="section-md pbmit-bg-color-global pbmit-extend-animation pbmit-extend-animation service-three_bg mt-5">
    ...
    <div class="container">
        <div class="pbmit-heading-subheading text-white">
            <h4 class="pbmit-subtitle">Fitur {{ $program->name }}</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                        <img src="{{ asset('storage/facilities/' . $facility->image) }}" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <span class="pbmit-service-icon elementor-icon">
                                    <i aria-hidden="true" class="pbmit-xcare-icon {{ $facility->id }}"></i>
                                </span>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <li>
                            <div class="pbmit-title-data-hover" data-text="Dental Care">
                                ...
                                <div class="pbmit-text-content d-flex align-items-center">
                                    <span class="pbminfotech-box-number">0{{ $loop->iteration }}</span>
                                    <a class="pbmit-title-inner" href="">
                                        <span>{{ $facility->title }}</span>
                                        <div class="small-text">{{ $facility->subtitle }}</div>
                                    </a>
                                ...
                                <a class="pbmit-link" href="{{ route('front.assessment.show', $facility->slug) }}"></a>
                            </div>
                        </li>
                        @endforeach
                        <li>
