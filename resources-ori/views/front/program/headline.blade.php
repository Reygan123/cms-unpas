        ...
        <div class="row g-0 align-items-center">
            <div class="col-md-12 col-xl-6">
                <div class="about-one_img"
                    style="background-image: url({{ asset('storage/programs/' . $program->image1) }})">
                                ...
                                <div class="pbmit-fld-wrap">
                                    <h4 class="pbmit-fid-inner">
                                        ...
                                        <span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits"
                                            data-from="0" data-to="{{ $program->class_size }}" data-interval="5"
                                            data-before="" data-before-style="" data-after=""
                                            data-after-style="">{{ $program->class_size }}</span>
            ...
            <div class="col-md-12 col-xl-6">
                <div class="about-one-rightbox">
                    <div class="pbmit-heading-subheading animation-style3">
                        <h4 class="pbmit-subtitle">{{ $program->name }}</h4>
                        <h2 class="pbmit-title">{{ $program->title1 }}</h2>
                    ...
                    <div class="pbminfotech-box-author row align-items-center">
                            ...
                            <div class="pbminfotech-box-img">
                                <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                        <img src="{{ asset('storage/ourteams/' . $program->ourteam->image) }}"
                                            class="img-fluid team-program" alt="{{ $program->ourteam->name }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-9 col-7">
                            <div class="pbmit-auther-content mx-2">
                                <h6 class="pbminfotech-box-title">{{ $program->ourteam->name }}</h6>
                                ...
                                @if ($program->id_yt)
                                    <div class="col-sm-5 text-center mt-4">
                                        <div class="pbmit-btn-box">
                                            <a href="https://www.youtube.com/watch?v={{ $program->id_yt }}"
