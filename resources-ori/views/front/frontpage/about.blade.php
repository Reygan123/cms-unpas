<section class="section-xl pbmit-extend-animation">
    <div class="container">
        <div class="row g-0 align-items-center">
            <div class="col-md-12 col-xl-6">
                <div class="about-us-left_box">
                    <div class="about-us_img1 pbmit-animation-style4">
                        <img src="{{asset('/storage/identities/'.$abouts[0]->image1)}}" class="img-fluid" alt="">
                    </div>
                    <div class="about-us_img2 pbmit-animation-style3">
                        <div class="image-container">
                            <img src="{{ asset('storage/identities/' . $abouts[0]->image2) }}" class="img-fluid"
                                alt="Gambar">
                            <div class="text-overlay">
                                <a class="button is-play pbmin-lightbox-video" href="https://www.youtube.com/watch?v={{ $abouts[0]->video }}">
            ...
            <div class="col-md-12 col-xl-6">
                <div class="about-us-right_box">
                    <div class="pbmit-heading-subheading">
                        <h4 class="pbmit-subtitle">{{$abouts[0]->title}}</h4>
                        <h2 class="pbmit-title">{{$identities[0]->name}}</h2>
                    ...
                    <a class="pbmit-btn" href="{{ route('home') }}/about-us">
