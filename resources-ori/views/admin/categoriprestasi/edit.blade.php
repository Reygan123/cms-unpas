        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.categoriprestasi.update', $categoriprestasi->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{ old('name', $categoriprestasi->name) }}" placeholder="Nama Kategori">
                                    @error('name')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                    <div class="mb-2 mt-4">
                                            @if($categoriprestasi->image)
                                            <img src="{{ asset('storage/categoriprestasis/' . $categoriprestasi->image) }}" alt="{{$categoriprestasi->title}}" class="admin-edit-image">
                                            @else
