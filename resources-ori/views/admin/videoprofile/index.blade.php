@extends('layouts.app', ['title' => 'Video Profil - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    ...
    @foreach ($videoprofiles as $videoprofile)
        ...
        <div class="row">
          <div class="">
          <iframe id="ais" width="100%" height="100%" src="https://www.youtube-nocookie.com/embed/{{$videoprofile->videoprofile}}" title="YouTube video player" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; " allowfullscreen></iframe>
          </div>
          <div>
