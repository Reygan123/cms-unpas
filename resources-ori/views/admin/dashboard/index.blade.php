        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-center">
              <div class="col-md-4">
                <img src="{{asset('storage/identities/'.$identities[0]->logo)}}" alt="{{ $identities[0]->name }}" class="logo">
                <div class="mt-4"></div>
                <h6 class="text-center">{!!$identities[0]->description!!}</h6>
              </div>
            </div>
          </div>
        </div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#user" role="tab" aria-controls="" aria-selected="true">
                            ...
                            <h4><span x-data="animatedCounter({{ $sumVisitors }},5, 0)" x-init="updatecounter" x-text="Math.round(current)"></span></h4>
...
?>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const visitorData = {!! json_encode($monthlyVisitors) !!};
